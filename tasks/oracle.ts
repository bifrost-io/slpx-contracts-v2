...
// yarn hardhat oracleSetFeeRate --network bsc --address 0x5b631863dF1B20AFb2715ee1F1381D6Dc1Dd065d  0 10
...
task("oracleSetFeeRate")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        console.log(`✅ Message Sent [${hre.network.name}] setFeeRate() to : ${tx}`)
    });
